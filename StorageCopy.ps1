...
$containerlist=$(az storage container list --account-name primstore --account-key $primstakey --sas-token $sasprimary --subscription "879ec86a-0a85-42f3-9b9a-4d1cdfa07053" --query "[].{name:name}" --output tsv)
